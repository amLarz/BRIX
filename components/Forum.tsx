...
const Forum: React.FC<ForumProps> = ({ posts, onPostClick, onCreatePostClick, onVote, userVotes }) => {
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1">
              <button
                ...
                className={`p-1 rounded-md transition-colors ${userVotes[post.id] === 'up' ? 'text-orange-600 bg-orange-50' : 'text-gray-400 hover:bg-gray-100'}`}
              >
              ...
              <button
                ...
                className={`p-1 rounded-md transition-colors ${userVotes[post.id] === 'down' ? 'text-blue-600 bg-blue-50' : 'text-gray-400 hover:bg-gray-100'}`}
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
